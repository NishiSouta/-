                        ...
                        foreach($sql as $row){
                            if( $_SESSION['user']['user_id'] == $row['user_id'] ){
                                echo 
                                    ...
                                    '</div>',
                                    '<div class="user_icon">',
                                    '<a href="my-profile.php"><img src="',$row['user_icon'],'" class="img_icon" alt="アイコン"></a>',
                                    $row['user_name'],
                                    '</div></div>';
                            }else{
                                echo
                                    '<div class="chat_left">',
                                    '<div class="user_icon">',
                                    '<a href="my-profile-user.php?user_id=',$row['user_id'],'&board_id=',$_GET['board_id'],'"><img src="',$row['user_icon'],'" class="img_icon" alt="アイコン"></a>',
                                    $row['user_name'],
                                    '</div>',
